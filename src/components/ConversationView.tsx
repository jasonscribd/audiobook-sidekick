      ...
      >
        ...
        <div className="w-[88px] flex justify-start">
          <button
            ...
            className="w-11 h-11 flex items-center justify-center text-white opacity-90 hover:opacity-100 focus:opacity-100 focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2 focus:ring-offset-bg transition-all duration-200 hover:bg-white hover:bg-opacity-10 rounded-full"
          >
